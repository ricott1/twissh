...
class GameClass(object):
    ...
    def __init__(self):
        ...
        self.base_actions = {
            ...
            "dash_up": action.DashUp,
            "dash_down": action.DashDown,
            "dash_left": action.DashLeft,
            "dash_right": action.DashRight,
...
class Nerd(GameClass):
    ...
    def __init__(self):
        ...
        self.class_actions = {
            ...
            "icewall": action.IceWall,
        }
        self.class_input = {
            "class_ability_1": "fireball",
            "class_ability_2": "teleport",
            "class_ability_3": "icewall",
        }
        self.bonus = {"INT": 1}
