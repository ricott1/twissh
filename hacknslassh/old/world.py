import random
import location, armory, bestiary, entity
from hacknslassh.world_map import *
    ...
    def __init__(self):
        self.locations = {
            ...
            "floor-0": quick_room(
                ...
                "Ground Floor",
                floor_0,
                {"common": 0.5, "uncommon": 0.25, "rare": 0.1},
            ),
            "floor-1": quick_room(
                self,
                "First Floor",
                floor_1,
                {"common": 0.35, "uncommon": 0.65, "rare": 0.25},
            ),
