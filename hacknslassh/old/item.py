from hacknslassh.utils import new_id
...
class Item(entity.Entity):
    def __init__(
        ...
        _rarity="common",
        _encumbrance=1,
        _in_inventory_markers=[],
        _in_inventory_marker_positions=[],
        **kwargs,
    ):
...
class Consumable(Item):
    def __init__(self, _marker="c", **kwargs):
        super().__init__(
            _marker=_marker,
            _in_inventory_markers=["U"],
            _in_inventory_marker_positions=[(0, 0)],
            **kwargs,
        )  # ⩌🝅
        self.eq_description = ""
...
class Helm(Equipment):
    def __init__(self, _marker="⌓", _encumbrance=2, **kwargs):
        super().__init__(
            ...
            _encumbrance=_encumbrance,
            _type="helm",
            _in_inventory_markers=["◜", "◝", "ᒋ", "ᒉ"],
            _in_inventory_marker_positions=[(0, 0), (0, 1), (1, 0), (1, 1)],
            **kwargs,
        )
        """
       ◜◝
...
class Belt(Equipment):
    def __init__(self, _marker="⑄", _encumbrance=2, **kwargs):
        ...
        super().__init__(
            ...
            _type="belt",
            _in_inventory_markers=["☰", "◎", "☰"],
            _in_inventory_marker_positions=[(0, 0), (0, 1), (0, 2)],
            **kwargs,
        )
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            ...
            _marker=_marker,
            _in_inventory_markers=["<", "=", "⫤", "-"],
            _in_inventory_marker_positions=[(0, 0), (0, 1), (0, 2), (0, 3)],
            **kwargs,
        )
        """
        <==⫤-
