...
class HPBottleImageCollection(object):
    ...
    R0 = Image(pg.image.load(f"{fileDir}/assets/bottles/hp_reg0.png"))
    R1 = Image(pg.image.load(f"{fileDir}/assets/bottles/hp_reg1.png"))
    R2 = Image(pg.image.load(f"{fileDir}/assets/bottles/hp_reg2.png"))
    R3 = Image(pg.image.load(f"{fileDir}/assets/bottles/hp_reg3.png"))
    R4 = Image(pg.image.load(f"{fileDir}/assets/bottles/hp_reg4.png"))
    R5 = Image(pg.image.load(f"{fileDir}/assets/bottles/hp_reg5.png"))
...
class MPBottleImageCollection(object):
    ...
    R0 = Image(pg.image.load(f"{fileDir}/assets/bottles/mp_reg0.png"))
    R1 = Image(pg.image.load(f"{fileDir}/assets/bottles/mp_reg1.png"))
    R2 = Image(pg.image.load(f"{fileDir}/assets/bottles/mp_reg2.png"))
    R3 = Image(pg.image.load(f"{fileDir}/assets/bottles/mp_reg3.png"))
    R4 = Image(pg.image.load(f"{fileDir}/assets/bottles/mp_reg4.png"))
    R5 = Image(pg.image.load(f"{fileDir}/assets/bottles/mp_reg5.png"))


class ImageCollection(object):
    EMPTY = Image(pg.Surface((0, 0), pg.SRCALPHA))
    BACKGROUND_NONE = Image(pg.image.load(f"{fileDir}/assets/background_none.png"))
